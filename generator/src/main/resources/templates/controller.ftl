...
public class ${tableName}Controller {
    ...
    public Result save(@RequestBody ${tableName} ${entityName}) {
        return new Result
<Long>().ok(${entityName}Service.save(${entityName}));
    }
    ...
    */
    ...
    return new Result
    <Integer>().ok(${entityName}Service.saveList(${entityName}List));
        }
        ...
        */
        ...
        return new Result
        <Integer>().ok(${entityName}Service.del(recordId));
            }
            ...
            */
            ...
            <Long> idList) {
                return new Result
                <Integer>().ok(${entityName}Service.delByIdList(idList));
                    }
                    ...
                    */
                    ...
                    return new Result
                    <Long>().ok(${entityName}Service.update(${entityName}));
                        }
                        ...
                        */
                        ...
                        <Long> idList) {
                            return new Result
                            <List
                            <${tableName}>>().ok(${entityName}Service.findByIdList(idList));
                            }
                            ...
                            */
                            ...
                            return new Result
                            <List
                            <${tableName}>>().ok(${entityName}Service.findByParam(${entityName}));
                            }
                            ...
                            */
                            ...
                            return new Result
                            <PageInfo>().ok(${entityName}Service.findByPage(pageInfo));
                                }
                                }