        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${basePath!}/static/pic.jpg" class="layui-nav-img userAvatar"
        ...
        function lockPage() {
            layer.open({
                ...
                content: '<div class="admin-header-lock" id="lock-box">' +
                        '<div class="admin-header-lock-img"><img src="${basePath!}/static/pic.jpg" class="userAvatar"/></div>' +
