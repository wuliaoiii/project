...
<#--↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓add↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓-->
<#--&lt;#&ndash;带有 class="layui-fluid" 的容器中，那么宽度将不会固定，而是 100% 适应&ndash;&gt;
<div id="addeditformdivid" hidden="" class="layui-fluid" style="margin: 15px;">
    <form class="layui-form" action="" id="addeditformid">
        <label  id="editlabelid"></label>
        <input id="editid" name="id" value="" />
        <div class="layui-form-item">
            <label class="layui-form-label">使用人主键</label>
            <div class="layui-input-block">
                <input type="text" id="uid" name="uid" lay-verify="userName" autocomplete="off" placeholder="请输入商品名"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">账户主键</label>
            <div class="layui-input-block">
                <input type="text" id="aid" name="aid" lay-verify="isNum" autocomplete="off"
