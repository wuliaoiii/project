...
public class UserController {
    ...
    public Result save(@RequestBody User user) {
        return new Result<Long>().ok(userService.save(user));
    }
    ...
    public Result save(@RequestBody List<User> userList) {
        return new Result<Integer>().ok(userService.saveList(userList));
    }
    ...
    public Result deleteById(@RequestParam("recordId") Long recordId) {
        return new Result<Integer>().ok(userService.del(recordId));
    }
    ...
    public Result deleteById(@RequestParam("idList") List<Long> idList) {
        return new Result<Integer>().ok(userService.delByIdList(idList));
    }
    ...
    public Result update(@RequestBody User user) {
        return new Result<Long>().ok(userService.update(user));
    }
    ...
    public Result findByIdList(@RequestParam("idList") List<Long> idList) {
        return new Result<List<User>>().ok(userService.findByIdList(idList));
    }
    ...
    public Result findByParam(@RequestBody User user) {
        return new Result<List<User>>().ok(userService.findByParam(user));
    }
    ...
    public Result findByPage(@RequestBody PageInfo<User> pageInfo) {
        return new Result<PageInfo>().ok(userService.findByPage(pageInfo));
    }
}