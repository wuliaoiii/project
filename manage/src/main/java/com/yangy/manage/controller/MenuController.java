...
public class MenuController {
    ...
    public Result save(@RequestBody Menu menu) {
        return new Result<Long>().ok(menuService.save(menu));
    }
    ...
    public Result save(@RequestBody List<Menu> menuList) {
        return new Result<Integer>().ok(menuService.saveList(menuList));
    }
    ...
    public Result deleteById(@RequestParam("recordId") Long recordId) {
        return new Result<Integer>().ok(menuService.del(recordId));
    }
    ...
    public Result deleteById(@RequestParam("idList") List<Long> idList) {
        return new Result<Integer>().ok(menuService.delByIdList(idList));
    }
    ...
    public Result update(@RequestBody Menu menu) {
        return new Result<Long>().ok(menuService.update(menu));
    }
    ...
    public Result findByIdList(@RequestParam("idList") List<Long> idList) {
        return new Result<List<Menu>>().ok(menuService.findByIdList(idList));
    }
    ...
    public Result findByParam(@RequestBody Menu menu) {
        return new Result<List<Menu>>().ok(menuService.findByParam(menu));
    }
    ...
    public Result findByPage(@RequestBody PageInfo<Menu> pageInfo) {
        return new Result<PageInfo>().ok(menuService.findByPage(pageInfo));
    }
}