...
public class RoleController {
    ...
    public Result save(@RequestBody Role role) {
        return new Result<Long>().ok(roleService.save(role));
    }
    ...
    public Result save(@RequestBody List<Role> roleList) {
        return new Result<Integer>().ok(roleService.saveList(roleList));
    }
    ...
    public Result deleteById(@RequestParam("recordId") Long recordId) {
        return new Result<Integer>().ok(roleService.del(recordId));
    }
    ...
    public Result deleteById(@RequestParam("idList") List<Long> idList) {
        return new Result<Integer>().ok(roleService.delByIdList(idList));
    }
    ...
    public Result update(@RequestBody Role role) {
        return new Result<Long>().ok(roleService.update(role));
    }
    ...
    public Result findByIdList(@RequestParam("idList") List<Long> idList) {
        return new Result<List<Role>>().ok(roleService.findByIdList(idList));
    }
    ...
    public Result findByParam(@RequestBody Role role) {
        return new Result<List<Role>>().ok(roleService.findByParam(role));
    }
    ...
    public Result findByPage(@RequestBody PageInfo<Role> pageInfo) {
        return new Result<PageInfo>().ok(roleService.findByPage(pageInfo));
    }
}